        ...
        <div className="min-h-screen bg-[var(--color-black)] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <form className="space-y-4 w-full relative z-10" onSubmit={handleRegister}>
                        ...
                        <div className="space-y-2 w-full">
                            <label className="text-[10px] font-black uppercase tracking-[0.15em] text-[var(--color-silver)] ml-2 block">Address</label>
                            <input
                                type="text"
                                value={formData.address}
                                onChange={(e) => setFormData({ ...formData, address: e.target.value })}
                                placeholder="Your address"
                                className="w-full bg-black/40 border border-white/10 rounded-xl py-4 px-4 text-sm text-white outline-none focus:border-[var(--color-accent)] focus:bg-black/60 transition-all font-semibold placeholder:text-white/20"
                            />
                        </div>
                ...
                <div className="mt-8 text-center w-full">
                    <button
                        ...
                        className="text-[9px] text-[var(--color-silver)]/60 font-black uppercase tracking-[0.3em] hover:text-[var(--color-accent)] transition-colors"
                    >
                        Admin Registration
                    </button>
                </div>
